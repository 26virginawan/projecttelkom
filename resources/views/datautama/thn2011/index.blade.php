    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Data Utama Tahun 2011</h3>
                        <br>


                        <div class="general-button">
                            <button type="button" class="btn mb-1 btn-success"><a href="/addutama2011"
                        ...
                        <div class="table-responsive">
                            ...
                            Jumlah Data : {{ $data_utama2011->total() }} <br> <br>
                            {{ $data_utama2011->links() }}
                        </div>
                    </div>
                </div>
            </div>
