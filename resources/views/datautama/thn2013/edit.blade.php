            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <br>
                        <h4 class="card-title">Edit Data Utama Tahuun 2013</h4>
                    </div>
                    <div class="card-body">
                        <form action="/datautama2013/update/{{$data_utama2013->id}}" method="post">
                            @csrf
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="input-group-append">
                                                                <select class="form-control" name="month">
                                                                    <option selected="{{$data_utama2013->month}}">
                                                                        {{$data_utama2013->month}}
                                                                    </option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="target"
                                                                value="{{$data_utama2013->target}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="relasi"
                                                                value="{{$data_utama2013->relasi}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="CALL_M"
                                                                value="{{$data_utama2013->CALL_M}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="CALL_C"
                                                                value="{{$data_utama2013->CALL_C}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
