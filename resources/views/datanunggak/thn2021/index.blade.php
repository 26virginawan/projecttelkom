        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Data Mitra Nunggak Tahun 2021</h3>
                    <table>

                        <tr>
                            <td><a href="/addnunggak2021" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                                    Tambah Data</a></td>
                        ...
                        <div class="d-flex justify-content-between text-right">
                            <div class="col-sm-4 offset-sm-8">
                                <form action="/carinunggak2021" method="get">
                                    <div class="card-body">
                    ...
                    Jumlah Data : {{ $data_nunggak2021->total() }} <br />
                    <br>
                    <table id="example2" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$b->sisa_hutang}}</td>
                                <td><a href="/editnunggak2021/{{$b->id}}" class="btn btn-warning">Edit</a>
                                    <a href="/datanunggak2021/delete/{{ $b->id }}" class="btn btn-danger"
