        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Data Mitra Nunggak Tahun 2014</h3>
                    <table>

                        <tr>
                            <td><a href="/addnunggak2014" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                                    Tambah Data</a></td>
                    ...
                    <table id="example2" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$b->sisa_hutang}}</td>
                                <td><a href="/editnunggak2014/{{$b->id}}" class="btn btn-warning">Edit</a>
                                    <a href="/datanunggak2014/delete/{{ $b->id }}" class="btn btn-danger"
                    ...
                    Jumlah Data : {{ $data_nunggak2014->total() }} <br />
