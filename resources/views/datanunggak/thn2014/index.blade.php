    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Data Nunggak Tahun 2014</h3>
                        <br>

                        <div class="header-right">
                            <div class="input-group icons">
                                <form action="/carinunggak2014" method="get">
                                    <div class="card-body">
                        ...
                        <div class="general-button">
                            <button type="button" class="btn mb-1 btn-success"><a href="/addnunggak2014"
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$b->sisa_hutang}}</td>
                                        <td><a href="/editnunggak2014/{{$b->id}}"
                                                class="btn btn-warning btn-sm">Edit</a>
                                            <a href="/datanunggak2014/delete/{{ $b->id }}" class="btn btn-danger btn-sm"
                            ...
                            Jumlah Data : {{ $data_nunggak2014->total() }} <br> <br>
                            {{ $data_nunggak2014->links() }}
                        </div>
                    </div>
                </div>
            </div>
