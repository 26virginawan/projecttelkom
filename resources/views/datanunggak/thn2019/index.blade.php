        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Data Mitra Nunggak Tahun 2019</h3>
                    <table>

                        <tr>
                            <td><a href="/addnunggak2019" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                                    Tambah Data</a></td>
                        ...
                        <div class="d-flex justify-content-between text-right">
                            <div class="col-sm-4 offset-sm-8">
                                <form action="/carinunggak2019" method="get">
                                    <div class="card-body">
                    ...
                    Jumlah Data : {{ $data_nunggak2019->total() }} <br />
                    <br>
                    <table id="example2" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$b->sisa_hutang}}</td>
                                <td><a href="/editnunggak2019/{{$b->id}}" class="btn btn-warning">Edit</a>
                                    <a href="/datanunggak2019/delete/{{ $b->id }}" class="btn btn-danger"
