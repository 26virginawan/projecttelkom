        ...
        <div class="row flex-grow">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/datanunggak2019/update/{{$data_nunggak2019->id}}" method="post">
                            @csrf
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="kode"
                                                                value="{{$data_nunggak2019->kode}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="nama"
                                                                value="{{$data_nunggak2019->nama}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="usaha"
                                                                value="{{$data_nunggak2019->usaha}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{$data_nunggak2019->tgl_terakhir_bayar}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-11 col-md-6 col-sm-12 space-bottom">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control"
                                                                name="terakhir_bayar"
                                                                value="{{$data_nunggak2019->terakhir_bayar}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="total_bayar"
                                                                value="{{$data_nunggak2019->total_bayar}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="total_angsur"
                                                                value="{{$data_nunggak2019->total_angsur}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="sisa_hutang"
                                                                value="{{$data_nunggak2019->sisa_hutang}}"></br>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
