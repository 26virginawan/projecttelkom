        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Data Mitra Nunggak Tahun 2018</h3>
                    <table>

                        <tr>
                            <td><a href="/addnunggak2018" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                                    Tambah Data</a></td>
                        ...
                        <div class="d-flex justify-content-between text-right">
                            <div class="col-sm-4 offset-sm-8">
                                <form action="/carinunggak2018" method="get">
                                    <div class="card-body">
                    ...
                    Jumlah Data : {{ $data_nunggak2018->total() }} <br />
                    <br>
                    <table id="example2" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$b->sisa_hutang}}</td>
                                <td><a href="/editnunggak2018/{{$b->id}}" class="btn btn-warning">Edit</a>
                                    <a href="/datanunggak2018/delete/{{ $b->id }}" class="btn btn-danger"
