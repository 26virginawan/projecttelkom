            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><a href="/addnunggak2011" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                                    Tambah Data</a></td>
                    ...
                    <table id="example2" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$b->sisa_hutang}}</td>
                                <td><a href="/editnunggak2011/{{$b->id}}" class="btn btn-warning">Edit</a>
                                    <a href="/datanunggak2011/delete/{{ $b->id }}" class="btn btn-danger"
                    ...
                    Jumlah Data : {{ $data_nunggak2011->total() }} <br />
