    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Data Nunggak Tahun 2013</h3>
                        <br>

                        <div class="header-right">
                            <div class="input-group icons">
                                <form action="/carinunggak2013" method="get">
                                    <div class="card-body">
                        ...
                        <div class="general-button">
                            <button type="button" class="btn mb-1 btn-success"><a href="/addnunggak2013"
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$b->sisa_hutang}}</td>
                                        <td><a href="/editnunggak2013/{{$b->id}}"
                            ...
                            Jumlah Data : {{ $data_nunggak2013->total() }} <br> <br>
