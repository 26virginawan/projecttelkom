        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$b->sisa_hutang}}</td>
                                <td><a href="/editnunggak2010/{{$b->id}}" class="btn btn-warning">Edit</a>
                                    <a href="/datanunggak2010/delete/{{ $b->id }}" class="btn btn-danger"
                    ...
                    Jumlah Data : {{ $data_nunggak2010->total() }} <br />
